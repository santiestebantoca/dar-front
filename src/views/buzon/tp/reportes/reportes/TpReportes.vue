<script setup>
const props = defineProps({ operar: Function })
  ...
  <div>
    <template v-if="mobile">
      <Teleport v-if="target" to="#app-footer-content">
        <div class="bg-light-2 hstack justify-content-center">
    ...
    <ReporteCard v-for="reporte in data" :key="reporte.id" :reporte="reporte" class="m-1"
      @operar="operar(reporte.id)" />
    <router-view />
  </div>
